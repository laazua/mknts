            ...
            "buckets": [
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.14",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.16",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.18",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.17",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.13",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.15",
                                    "_type": "_doc",
                ...
                },
                {
                    ...
                    "country_tag": {
                        "hits": {
                            ...
                            "hits": [
                                {
                                    "_index": "access-www-yuzhua-2024.01.12",
                                    "_type": "_doc",
...
class TestReq(unittest.TestCase):
    def test_format_dsl(self):
        pass
        # _dsl = req._format_dsl("yuzhua", dsl.CntType.Week)
        # print(_dsl)
        # self.assertFalse(_dsl is None, "_format_dsl() is Failure!")

    # def test_format_index(self):
    #     index = req._format_index("yuzhua")
    #     self.assertFalse(index is None, "_format_index() is Failure!")

    # def test_format_data(self):
    #     req.format_index_data(data)
    def test_get_data(self):
        pass
        # req.get_data("1youduo", dsl.CntType.Week)

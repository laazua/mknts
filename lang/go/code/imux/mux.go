...
// Handle 注册路由
func (r *Router) Handle(method, pattern string, handleFun http.HandlerFunc) {
...
// Get 注册 GET 请求路由
func (r *Router) Get(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodGet, pattern, handleFun)
}

// Post 注册 POST 请求路由
func (r *Router) Post(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodPost, pattern, handleFun)
}

// Delete 注册 DELETE 请求路由
func (r *Router) Delete(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodDelete, pattern, handleFun)
}

// Put 注册 PUT 请求路由
func (r *Router) Put(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodPut, pattern, handleFun)
}

// Patch 注册 Patch 请求路由
func (r *Router) Patch(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodPatch, pattern, handleFun)
}

// Head 注册 Head 请求路由
func (r *Router) Head(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodHead, pattern, handleFun)
}

// Options 注册 Options 请求路由
func (r *Router) Options(pattern string, handleFun http.HandlerFunc) {
	r.Handle(http.MethodOptions, pattern, handleFun)
}
